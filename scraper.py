...
def _is_watch_product(product: Dict[str, Any]) -> bool:
    ...
    # Include only watch-related items
...
def run_scraper(delay_range: Tuple[float, float] = (0.2, 0.6)):
    ...
    try:
        ...
        products = fetch_products_collection(
            COLLECTION_HANDLE,
        ...
        parsed_rows = [map_product_to_parsed_row(p, extraction_date) for p in products]
